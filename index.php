...
<html style="height:100%;">
	...
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo _fCdnPath_;?>images/sc/x114.png">
	<!-- For first- and second-generation iPad: -->
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo _fCdnPath_;?>images/sc/x72.png">
	<!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
	<link rel="apple-touch-icon-precomposed" href="<?php echo _fCdnPath_;?>images/sc/x57.png">

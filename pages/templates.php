...
<div id="templates">
	...
	<div id="te_sc_shift_display_info">
		...
		<div class="title1 wide">
			<a onclick = "void(0)" id="get_directions" rel="http://maps.google.com/maps?f=d&hl=en&geocode=&saddr=${user_location}&daddr=${location.address}&ie=UTF8&z=7&output=embed">Get directions</a>
			<a onclick = "void(0)" class="fr" id="get_map" rel="http://maps.google.com/maps?f=d&source=s_d&saddr=${location.address}&hl=en&z=15&output=embed">Map</a>
		</div>
		{{/if}}

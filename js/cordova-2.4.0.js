...
var cordova = {
    ...
    callbackError: function(callbackId, args) {
        // Deprecate callbackSuccess and callbackError in favour of callbackFromNative.
...
function androidExec(success, fail, service, action, args) {
    ...
    // Returning the payload of a synchronous call was deprecated in 2.2.0.
...
androidExec.processMessages = function(messages) {
    if (messages) {
        ...
        while (messagesFromNative.length) {
            ...
            // (agrieve): This is currently disabled on the Java side
 ...
 * implement this!!! {FileSystem} filesystem on which the directory resides (readonly)
 */
...
FileReader.prototype.readAsBinaryString = function(file) {
    ...
    //  - Can't return binary data to browser.
...
// MediaError.MEDIA_ERR_NONE_SUPPORTED is legacy, the W3 spec now defines it as below.
...
var ProgressEvent = (function() {
    ...
    var createEvent = function(data) {
        ...
        if (data) {
            ...
            if (data.target) {
                // cannot call <some_custom_object>.dispatchEvent
